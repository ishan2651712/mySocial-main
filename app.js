...
//   res.header("Access-Control-Allow-Origin", "http://localhost:3000"); // add when in prod: http://mys0cial.herokuapp.com, dev:http://localhost:3000
...
app.use("/api/social/users", userRouter);
